...
$route['admin/projectstatus/statuses'] = 'admin/ProjectStatus/statuses';
$route['admin/projectstatus/status']  = 'admin/ProjectStatus/status';
$route['admin/projectstatus/delete/(:num)'] = 'admin/ProjectStatus/delete_project_status/$1';
