...
class ProjectType extends AdminController
{
    ...
    public function type()
    {
        ...
        if ($this->input->post()) {
            ...
            // CREATE
            if (!isset($post['id'])) {
                $id = $this->projects_model->add_project_type($post);
                if ($id) {
            ...
            // UPDATE
                ...
                $success = $this->projects_model->update_project_type($post, $id);
    ...
    public function delete_project_type($id)
    {
        ...
        $response = $this->projects_model->delete_project_type($id);
