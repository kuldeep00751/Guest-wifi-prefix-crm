                  ...
                  <div role="tabpanel" class="tab-pane active" id="tab_project">
                    ...
                    <div class="form-group select-placeholder">
                     ...
                     <div class="row">   
                        ...
                        <div class="col-md-6" id="wifiRouterSerialBox" style="display: none;">
                        ...
                        <div class="col-md-6" id="wirelessDeviceSerialBox" style="display: none;">
                        ...
                        <div class="col-md-6" id="modemOnuSerialBox" style="display: none;">
                           <label for="wifi_router" class="control-label"><?= _l('Wireless Device Serial Number'); ?></label>
...
<script>
    // WiFi Router serial toggle
    document.getElementById('wifiRouter').addEventListener('change', function() {
        document.getElementById('wifiRouterSerialBox').style.display = 
            this.value === 'Yes' ? 'block' : 'none';
    });

    // Wireless Device serial toggle
    document.getElementById('wirelessDevice').addEventListener('change', function() {
        document.getElementById('wirelessDeviceSerialBox').style.display = 
            this.value === 'Yes' ? 'block' : 'none';
    });

    // Modem/ONU serial toggle
    document.getElementById('modemOnu').addEventListener('change', function() {
        document.getElementById('modemOnuSerialBox').style.display = 
            this.value === 'Yes' ? 'block' : 'none';
    });
</script>
</body>
