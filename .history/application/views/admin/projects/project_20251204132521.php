                  ...
                  <div role="tabpanel" class="tab-pane active" id="tab_project">
                    ...
                    <div class="form-group select-placeholder">
                     ...
                     <div class="row">   
                        ...
                        <div class="col-md-12">
                           <label for="hardwareConnectionType" class="control-label"><strong>Connection Type <span style="color:red">*</span></strong></label><br>
                           <label class="control-label"><input type="radio" name="connection_type" value="air_fiber" required> Air Fiber</label>&nbsp;&nbsp;
                           <label class="control-label"><input type="radio" name="connection_type" value="lease_fiber" required> Lease Fiber</label>&nbsp;&nbsp;
                           <label class="control-label"><input type="radio" name="connection_type" value="wireless_rf" required> Wireless RF</label>
                        </div>
                     </div>
                     <p class="bold">
