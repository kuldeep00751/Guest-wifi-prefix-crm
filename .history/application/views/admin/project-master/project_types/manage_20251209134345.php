                ...
                <div class="panel_s">
                    <div class="panel-body panel-table-full">
                        ...
                        <table class="table dt-table">
                            <thead>
                                <th><?= _l('id'); ?></th>
                                <th><?= _l('project_types_dt_name'); ?></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tw-flex tw-items-center tw-space-x-2">
                                            ...
                                            <?php if ($type['isdefault'] == 0 || $type['isdefault'] == 1) { ?>
                                            <a href="<?= admin_url('ProjectMaster/delete_project_type/' . $type['projecttypeid']); ?>"
...
<div class="modal fade" id="project_type_modal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?= form_open(admin_url('ProjectMaster/project_type')); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?= render_input('name', 'project_types_dt_name'); ?>
            </div>
