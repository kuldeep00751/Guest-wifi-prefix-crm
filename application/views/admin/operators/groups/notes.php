...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="usernote hide">
            <?= form_open(admin_url('misc/add_note/' . $operator->userid . '/operator')); ?>
        ...
        <table class="table dt-table" data-order-col="2" data-order-type="desc">
            <thead>
                <tr>
                    <th width="50%">
                        <?= _l('operators_notes_table_description_heading'); ?>
                    </th>
                    <th>
                        <?= _l('operators_notes_table_addedfrom_heading'); ?>
                    </th>
                    <th>
                        <?= _l('operators_notes_table_dateadded_heading'); ?>
                    </th>
                    <th class="options">
                        <?= _l('options'); ?>
                    </th>
