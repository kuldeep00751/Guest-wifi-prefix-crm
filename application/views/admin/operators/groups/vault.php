...
<div
    ...
    <div class="tw-flex tw-justify-between tw-items-center tw-px-6 tw-py-3 tw-border-b tw-border-solid tw-border-neutral-200 tw-bg-neutral-50"
        ...
        <div class="tw-flex-inline tw-items-center tw-space-x-2">
            ...
            <a href="<?= admin_url('operators/vault_entry_delete/' . $entry['id']); ?>"
...
<div class="modal fade" id="entryModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <?= form_open(admin_url('operators/vault_entry_create/' . $operator->userid), ['data-create-url' => admin_url('operators/vault_entry_create/' . $operator->userid), 'data-update-url' => admin_url('operators/vault_entry_update')]); ?>
...
<!-- /.modal -->
<?php $this->load->view('admin/operators/vault_confirm_password'); ?>
...
<script>
    ...
    function edit_vault_entry(id) {
        $.get(admin_url + 'operators/get_vault_entry/' + id, function(response) {
            var $form = $entryModal.find('form');
