                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mtop15">
                                ...
                                <?= form_hidden('operators_import', 'true'); ?>
                                <?= render_input('file_csv', 'choose_csv_file', '', 'file'); ?>
                                <?php
                if (is_admin() || get_option('staff_members_create_inline_operator_groups') == '1') {
                    echo render_select_with_input_group('groups_in[]', $groups, ['id', 'name'], 'operator_groups', ($this->input->post('groups_in') ? $this->input->post('groups_in') : []), '<div class="input-group-btn"><a href="#" class="btn btn-default" data-toggle="modal" data-target="#operator_group_modal"><i class="fa fa-plus"></i></a></div>', ['multiple' => true, 'data-actions-box' => true], [], '', '', false);
                } else {
                    echo render_select('groups_in[]', $groups, ['id', 'name'], 'operator_groups', ($this->input->post('groups_in') ? $this->input->post('groups_in') : []), ['multiple' => true, 'data-actions-box' => true], [], '', '', false);
                }
echo render_input('default_pass_all', 'default_pass_operators_import', $this->input->post('default_pass_all')); ?>
