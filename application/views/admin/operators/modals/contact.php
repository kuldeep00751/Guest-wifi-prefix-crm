...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?= form_open(admin_url('operators/form_contact/' . $operator_id . ($contactid ? '/' . $contactid : '')), ['id' => 'contact-form', 'autocomplete' => 'off']); ?>
                ...
                <div class="tw-flex">
                    <div class="tw-mr-4 tw-flex-shrink-0 tw-relative">
                        ...
                        <img src="<?= e(contact_profile_image_url($contact->id, 'small')); ?>"
                            id="contact-img" class="operator-profile-image-small">
                    ...
                    <div>
                        ...
                        <p class="tw-mb-0">
                            <?= e(get_company_name($operator_id, true)); ?>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div id="contact-profile-image"
                            ...
                            <label for="profile_image"
                                class="profile-image"><?= _l('operator_profile_image'); ?></label>
                        ...
                        <div class="operator_password_set_wrapper">
                            <label for="password" class="control-label">
                                <?= _l('operator_password'); ?>
                            </label>
                            ...
                            <p class="text-muted tw-mt-2">
                                <?= _l('operator_password_change_populate_note'); ?>
                            </p>
                            <?php if ($contact->last_password_change != null) { ?>
                            <?= _l('operator_password_last_changed'); ?>
                        ...
                        <div class="checkbox">
                            <input type="checkbox" name="is_primary" id="contact_primary"
                                <?= ((! isset($contact) && total_rows(db_prefix() . 'contacts', ['is_primary' => 1, 'userid' => $operator_id]) == 0) || (isset($contact) && $contact->is_primary == 1)) ? 'checked' : ''; ?><?= ((isset($contact) && total_rows(db_prefix() . 'contacts', ['is_primary' => 1, 'userid' => $operator_id]) == 1 && $contact->is_primary == 1)) ? ' disabled' : ''; ?>>
                            <label for="contact_primary">
                                <?= _l('contact_primary'); ?>
                            </label>
                        </div>
                        <?php if (! isset($contact) && is_email_template_active('new-operator-created')) { ?>
                        <div class="checkbox">
                            <input type="checkbox" name="donotsendwelcomeemail" id="donotsendwelcomeemail">
                            <label for="donotsendwelcomeemail">
                                <?= _l('operator_do_not_send_welcome_email'); ?>
                            </label>
                        </div>
                        <?php } ?>
                        ...
                        <div class="checkbox">
                            ...
                            <label for="send_set_password_email">
                                <?= _l('operator_send_set_password_email'); ?>
                            </label>
                        </div>
                        <?php } ?>
                        <hr />
                        <p class="bold">
                            <?= _l('operator_permissions'); ?>
                        </p>
                        <p class="text-danger">
                        ...
                        <?php foreach ($operator_permissions as $permission) { ?>
