                ...
                <div class="panel_s">
                    <div class="panel-body panel-table-full">
                        ...
                        <table class="table dt-table">
                            <thead>
                                <th><?= _l('id'); ?></th>
                                <th><?= _l('project_statuss_dt_name'); ?></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="tw-flex tw-items-center tw-space-x-2">
                                            ...
                                            <?php if ($status['isdefault'] == 0 || $status['isdefault'] == 1) { ?>
                                            <a href="<?= admin_url('ProjectMaster/delete_project_status/' . $status['projectstatusid']); ?>"
...
<div class="modal fade" id="project_status" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?= form_open(admin_url('ProjectMaster/project_status')); ?>
        <div class="modal-content">

            <div class="modal-header">
                <button type="button"class="close" data-dismiss="modal"><span>&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title"><?= _l('project_statuss_dt_name'); ?></span>
